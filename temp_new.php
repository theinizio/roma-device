...
$link->query("INSERT INTO `data` (`time`, `t1`, `t2`, `t3`, `t4`, `t5`, `t6`, `t7`, `t8`, `t9`, `t10`, `r1`, `r2`, `r3`, `r4`, `r5`, `r6`, `r7`, `r8`)
...
$arr=base64_encode(char_encode($arr));


$my_id="826khyQ9995TP2p";
$url = "http://zaimka.cloudaccess.host/login/slim.php?id=$my_id&p=$arr";
echo $url."<br>";
$name=(file_get_contents($url,false));
//print_r($name);
$name=base64_decode($name);
$data_from_device=json_decode(char_decode($name),true);
...
$data_from_device=json_decode($name,true);
				...
				//var_dump($data_from_device);
				//echo"</font><br>";
				//echo $data_from_device["timestamp"]."<br>";
